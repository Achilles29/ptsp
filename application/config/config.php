...
// $config['base_url'] = 'https://ptsp.rembangkab.cloud/';
...
$config['sess_expiration'] = 86400 * 365 * 5; // 5 tahun
$config['sess_time_to_update'] = 300;   // refresh tiap 5 menit
$config['sess_regenerate_destroy'] = FALSE;
$config['sess_match_ip'] = FALSE;
$config['sess_samesite'] = 'Lax';
$config['sess_cookie_secure'] = FALSE; // TRUE kalau HTTPS
