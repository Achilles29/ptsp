...
class User_model extends CI_Model
{
  ...
  public function update_verification_token($id, $token)
  {
  ...
  public function update_verification_sent_at($id, $datetime = null)
  {
    $this->db->where('id', (int) $id)
      ->update($this->table, [
        'verification_sent_at' => $datetime ?: date('Y-m-d H:i:s'),
        'updated_at' => date('Y-m-d H:i:s')
      ]);
  }
