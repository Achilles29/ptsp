    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            <div class="card border-start border-warning shadow-sm">
                <div class="card-body">
                    <h6 class="text-muted"><i class="fas fa-building me-1 text-warning"></i> Layanan Tersedia</h6>
                    <h3 class="text-warning fw-bold">Portal</h3>
                    <div class="small">Daftar online, cek status, dan riwayat kunjungan</div>
                </div>
            </div>
        </div>
    </div>
