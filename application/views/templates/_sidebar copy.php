        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="<?= base_url('admin/desa'); ?>" class="menu-link">
                                <div data-i18n="Without menu">Master Desa</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="<?= base_url('admin/kecamatan'); ?>" class="menu-link">
                                <div data-i18n="Without navbar">Master Kecamatan</div>
                            </a>
                        </li>
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="<?= base_url('admin/inventaris'); ?>" class="menu-link">
                        <i class="menu-icon icon-base ri ri-bank-card-2-line"></i>
